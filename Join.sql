create table Student_join( Id int , Fname Varchar(15),Lname Varchar(15),Age int(3),City varchar(10),Form_no varchar(2)primary key);
...
create table fees(form_no varchar(4),foreign key(form_no) references Student_join(form_no),amount int,course varchar(15));

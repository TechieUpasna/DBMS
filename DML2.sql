create table  javastudent2 (id int primary key,sname varchar(20) not null,sphone bigint(11) not null unique,semail varchar(30) not null unique,sadd varchar(50),squalifiation varchar(10) not null,sdept varchar(20));
